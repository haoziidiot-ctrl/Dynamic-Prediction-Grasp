"""
Generate rollout trajectory plots for DPG_mujoco_analytic.
...
Usage:
    python DPG_mujoco_analytic/DPG_generate_plots.py
"""
...
def _build_controller(traj) -> MPCController:
    # Keep consistent with DPG_mujoco_analytic/DPG_main.py defaults.
...
def parse_args():
    ...
    parser.add_argument(
        "--out-dir",
        type=str,
        default="DPG_mujoco_analytic/plots",
