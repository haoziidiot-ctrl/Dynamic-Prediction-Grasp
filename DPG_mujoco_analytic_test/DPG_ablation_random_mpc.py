...
- random_mpc_on = 1 -> 约束QP + 禁区规避门控 + 禁区逃逸补偿
- random_mpc_on = 0 -> 默认解析MPC
...
def _build_controller(
    ...
    *,
    ...
    # 与 DPG_mujoco_analytic_test/DPG_main.py 当前版本对齐；
    # random_mpc_on=1 时，启用约束QP并打开“禁区规避门控+逃逸补偿”。
    return MPCController(
        ...
        qp_zone_avoid_enable=bool(random_mpc_on),
        qp_zone_x_half_width=ZONE_X_HALF_WIDTH,
        qp_zone_y_back=ZONE_Y_BACK,
        ...
        json.dump(
            {
                ...
                "switch_mapping": {
                    "random_mpc_on": {
                        ...
                        "activation": {
                            "enable_during_hold": False,
                            "activate_x_err_threshold": 0.12,
                        },
                        "zone_avoidance": {
                            "enabled": True,
                            "x_half_width": ZONE_X_HALF_WIDTH,
                            "y_back": ZONE_Y_BACK,
                            "y_margin": 0.005,
                            "x_gate_margin": 0.01,
                            "escape_gain_x": 1.2,
                            "escape_gain_y": 0.9,
                            "escape_speed_cap": 0.20,
                            "escape_disable_near_err": 0.05,
                            "escape_full_err": 0.16,
                        },
                    },
                    "random_mpc_off": {
